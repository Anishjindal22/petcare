...
exports.updateProduct = async (req, res, next) => {
  try {
    ...
    return res.status(403).json({
      success: false,
      message:
        "Internal server error cannot update product please try again later ",
    });
  }
};
...
exports.deleteProduct = async (req, res, next) => {
  try {
    ...
    return res.status(403).json({
      success: false,
      message:
        "Internal server error not able to delete the product please try again later",
    });
  }
};
...
exports.getProductDetails = async (req, res, next) => {
  try {
    ...
    return res.status(502).json({
      success: false,
      message:
        "Internal server error cannot get product details please try again later",
    });
  }
};
